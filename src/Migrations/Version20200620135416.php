 ...
 */
final class Version20200620135416 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE blog_post DROP abstract');
    }
}
